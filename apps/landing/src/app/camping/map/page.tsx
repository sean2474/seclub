...
export default function Page() {
  return (
    <main className="mt-[var(--header-height-expanded)] pt-4 flex flex-col items-center gap-4">
      <h2 className="mt-4">SE Club 전체 시설 배치도</h2>
      <Modal>
        <div className="relative h-[50svh] w-full p-2">
          <ModalTrigger>
            <Image src="/images/about/map.png" alt="SE Club 전체 시설 배치도" fill className="object-contain" />
          </ModalTrigger>
        </div>
