...
import { ArrowRight, Calendar, Check, Ban } from "lucide-react"
    ...
    <div className="min-h-screen font-sans mt-[var(--header-height-expanded)] pt-10">
      <main className="px-8 md:px-12 pb-24">
        <section id="overview" className="mb-16">
          <h2 className="text-3xl md:text-4xl mb-8 font-serif">Overview & Packages</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1">
              <Card className="bg-stone-200/50 border-none p-6 h-full flex flex-col justify-between">
                <div>
            ...
            <Link href="/wellness/camping-pool" className="relative group overflow-hidden rounded-lg">
              <Image
            ...
            <Link href="/wellness/walk" className="relative group overflow-hidden rounded-lg">
              <Image
        ...
        <section id="sites">
          <div className="flex justify-between items-end mb-8">
            ...
            <div className="hidden md:flex items-center gap-2">
              전체보기{" "}
              <Button variant="outline" size="icon" className="ml-2 rounded-full w-8 h-8 bg-transparent">
                <ArrowRight className="w-4 h-4" />
              </Button>
            </div>
          </div>

          <div className="flex space-x-2 mb-8 overflow-x-auto pb-2 -mx-8 px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
              {filteredSites.map((site) => (
                <div key={site.id} className="group relative">
                  ...
                  <ModalTrigger className="mt-4">
                    <button className="justify-start h-auto flex items-center cursor-pointer" onClick={() => setOpenedSite(site.id)}>
      ...
      <Button className="fixed bottom-8 right-8 rounded-full h-16 w-16 md:h-20 md:w-20 shadow-lg bg-stone-800 hover:bg-stone-700 text-white flex flex-col items-center justify-center">
        <Calendar className="w-6 h-6 md:w-7 md:h-7" />
        <span className="text-xs mt-1">예약하기</span>
      </Button>
    </div>
  )
}
