      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 py-12">
        <Accordion type="single" collapsible className="w-full">
            ...
            <InfoList
              items={[
                ...
                <span key="four-month-reservation">
                  <strong>4개월 차 예약 오픈:</strong> 매월말일 24:00에 자동으로 오픈됩니다. (예: 4월 예약은 1월 31일 24:00부터 가능)
                </span>,
                <span key="special-reservation">
                  <strong>특별 예약:</strong> 3개월 이후 일정에 3박 이상 확정된 경우, 또는 시스템 이용이 번거로우실 때는 예약담당(☎ 010-9703-1711)에게 문의 해 주세요.
                </span>,
              ]}
            />
          </Section>
          ...
          <Section title="2. 결제 안내">
            <InfoList
              items={[
                ...
                "결제 시 '예약자 이름'을 정확히입력해주세요. (예: 홍길동✓ / 홍길동, 홍길동(A)✕)",
                "현장에서 현금 결제처리는 불가능합니다.",
              ]}
            />
          </Section>
          ...
          <Section title="5. 유의사항">
            <InfoList
              items={[
                "풀장 운영기간은 7월 ~ 8월이며, 확정 일정은 공지를 통해 별도 안내됩니다.",
                "22:00 이후 도착 시 야간 담당자(☎ 010-4668-1704)에게 사전 연락이 필수입니다.",
        ...
        <div className="mt-16 text-center">
          ...
          <div className="space-y-2 text-lg">
            ...
            <p>
              관리실 (현장 문의):{" "}
              <a href="tel:010-4668-1704" className="font-semibold hover:underline">
                010-4668-1704
              </a>
            </p>
          </div>
