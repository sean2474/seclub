  ...
  return (
    <>
      ...
      <main className="mx-auto">
        <section className="space-y-8 pt-16 center relative mt-[95svh] bg-background">
            ...
            <div className="max-w-6xl pb-16 mx-auto border-b border-gray-400/50">
              ...
              <ol className="border border-gray-400/50 p-5 mt-5 space-y-4 list-decimal pl-10">
                <li className="space-y-2">
                  <div className="font-medium">수영장 안내</div>
                  <ul className="space-y-1">
                    <li> - 수영장의 크기는 가로 4.5m, 세로 2.5m, 깊이 0.9m이며 바닷물을 사용합니다.</li>
                    <li> - 이용 기간은 7월과 8월이며, 시즌은 2024년 6월 14일부터 9월 8일까지입니다.</li>
                    <li> - 수위는 0.75m 이하로 유지되며, 체크인 시 물을 교체합니다.</li>
                    <li> - 어린이는 반드시 구명조끼 등 안전 장비를 착용하고 보호자와 함께 이용해야 하며, 다이빙·점프·뜀박질 등 위험 행위는 금지됩니다.</li>
                  </ul>
                </li>
                <li className="space-y-2">
