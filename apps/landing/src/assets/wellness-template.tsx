...
export const WellnessTemplate = ({ wellnessData: wellnessPageData, slug }: { wellnessData: WellnessPageData, slug: string }) => {
  return (
    <main className="mt-[var(--header-height-expanded)] pt-20">
      <section className="center flex-col max-w-4xl w-full mx-auto">
        ...
        <div className="mt-8 p-4 w-full bg-beige/10">
          <div className="grid grid-cols-3 w-full divide-x">
            ...
            <div className="flex items-center gap-4 p-4">
              <MapIcon className="w-12 h-12" strokeWidth={0.5} />
              <div>
                <div>위치</div>
            ...
            <div className="flex items-center gap-4 p-4">
              <ClockIcon className="w-12 h-12" strokeWidth={0.5} />
      ...
      <section className="bg-background center w-full relative pb-0 md:pb-10 pt-5">
        ...
        <div className="w-full max-w-6xl p-3.5">
          <div className="relative w-full h-80 md:h-[700px] max-w-4xl mx-auto">
            <Image src={"/images/wellness/swimming-pool.jpg"} alt="SE클럽 수영장" fill className="object-cover" />
          </div>
        </div>
      </section>
      <section>
        <div className="bg-background w-full pt-6 md:pt-0 center">
          <div className="max-w-4xl pb-16 mx-4 w-full mt-15">
